// Slight modification of https://github.com/coderbot16/java-rand
// includes AbstractRandom, may be useful later on
...
impl AbstractRandom for Random {
	...
	fn next_i32_bound(&mut self, max: i32) -> i32 {
		if max <= 0 {
